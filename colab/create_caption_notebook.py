"""
create_caption_notebook.py
Run once locally:  python colab/create_caption_notebook.py
Generates:        colab/comic_studio_caption.ipynb

Colab GPU needed: None (CPU is fine) or T4 (free tier)
Runtime:          30-60 min for 1300 images with Florence-2
"""
import json
from pathlib import Path

def cell(source: list[str], cell_type="code") -> dict:
    return {
        "cell_type": cell_type,
        "metadata": {},
...
nb = {
    ...
    "nbformat_minor": 0,
    "metadata": {
        "colab": {"name": "Comic Studio — Auto Caption", "provenance": [], "gpuType": "T4"},
...
out = Path(__file__).parent / "comic_studio_caption.ipynb"
